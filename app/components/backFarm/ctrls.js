...
clesunClound
    ...
    ["$rootScope", "$scope", "cacheService",
        ...
        function ($rootScope, $scope, cacheService, userService, commonService, constantService, productService, produceService, bannerService, carticleService) {
            //获取产品对象
            productService.getProductByProductId($rootScope.$stateParams.productid).then(function (res) {
                if (res.CODE == '0') {
                    if (res.DATA) {
    ...
    ["$rootScope", "$scope", "cacheService",
        ...
        function ($rootScope, $scope, cacheService, userService, commonService, constantService, productService, bannerService, carticleService, accountService) {
            //编辑状态
            $scope.publishEdit = true;
            $scope.editpage = true;//是编辑界面
            //获取产品对象
    ...
    ["$rootScope", "$scope", "$state", "cacheService",
        ...
        function ($rootScope, $scope, $state, cacheService, userService, commonService, constantService, produceService, productService) {
    ...
    ["$rootScope", "$scope", "$state", "cacheService",
        ...
        function ($rootScope, $scope, $state, cacheService, userService, commonService, constantService, cquotationbillService, accountService, productService, bannerService, carticleService) {
            //编辑状态
            $scope.publishEdit = true;
            $scope.editpage = true;//是编辑界面
            //获取活动对象
