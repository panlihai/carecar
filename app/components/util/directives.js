 ...
 * Version: 0.0.2
 */
clesunClound.directive('pagination', [function () {
    return {
        restrict: 'EA',
        template: '<div class="page-list pull-right">' +
            '<ul class="pagination" ng-show="conf.totalItems > 0" style="margin-top: 0px;margin-bottom: 0px;">' +
            ...
            '</div>' +
            '<div class="no-items text-danger " ng-show="conf.totalItems <= 0">暂无数据</div>' +
            '</div>',
        replace: true,
        scope: {
            conf: '='
