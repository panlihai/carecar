...
clesunClound.controller("navCtrl", ["$rootScope", "$scope", "$state", "userService", "commonService",
    ...
    function ($rootScope, $scope, $state, userService, commonService, cacheService, $window, constantService, utilsService, actService) {
...
// 控制器个人资料
    ...
    .controller("placeorderCtrl", ["$rootScope", "$scope", "$state", "actService", "cacheService", "appService", "placeorderService",
        ...
        function ($rootScope, $scope, $state, actService, cacheService, appService, accountService, locationService, bannerService, certService) {
